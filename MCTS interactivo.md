...
- `selected`: Si el nodo ha sido seleccionado previamente. Se prefiere valor `False` si los nodos seleccionados es menor a $\sqrt{n_d}-sn_d$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5MTkzNTEyNSw5Nzk3NDgxNiwtNTI5Mz
